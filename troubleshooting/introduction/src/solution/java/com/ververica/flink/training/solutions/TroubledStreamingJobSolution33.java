...
/**
 * Troubled streaming job evolved on top of {@link TroubledStreamingJobSolution32} by optimising
 * latency with a reduced buffer timeout.
 */
public class TroubledStreamingJobSolution33 {
	...
	public static void main(String[] args) throws Exception {
		...
		env.execute(TroubledStreamingJobSolution33.class.getSimpleName());
	}
