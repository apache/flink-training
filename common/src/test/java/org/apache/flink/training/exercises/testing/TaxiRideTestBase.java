...
public abstract class TaxiRideTestBase<OUT> {
    ...
    protected List<OUT> runApp(
            TestRideSource source, TestSink<OUT> sink, Testable exercise, Testable solution)
            throws Exception {
    ...
    protected List<OUT> runApp(
            TestFareSource source, TestSink<OUT> sink, Testable exercise, Testable solution)
            throws Exception {
    ...
    protected List<OUT> runApp(TestRideSource rides, TestSink<OUT> sink, Testable solution)
            throws Exception {
        ExerciseBase.rides = rides;
    ...
    private List<OUT> execute(TestSink<OUT> sink, Testable exercise, Testable solution)
            throws Exception {
        sink.VALUES.clear();
